                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="card-title m-t-40"><i class="m-r-5 font-18 mdi mdi-numeric-1-box-multiple-outline"></i>Pending Submit Order</h6>
                                    <div class="table-responsive">
                                        <%
                                            ArrayList<Order_Product> pedingsubmitlist = (ArrayList<Order_Product>) request.getAttribute("pedingsubmitlist");
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <%                                                if (pedingsubmitlist != null) {
                                                        for (Order_Product i : pedingsubmitlist) {
                                                ...
                                                <tr>
                                                    ...
                                                    <th> <a href="CancelOrder?id=<%=i.getId_order()%>" target="target">Cancel Order</a></td>
                                                </tr>
                                                <%}
                                                    }%>
                                            </tbody>
                                    ...
                                    <h6 class="card-title m-t-40"><i class="m-r-5 font-18 mdi mdi-numeric-1-box-multiple-outline"></i> Pending Ship Order</h6>
                                    <div class="table-responsive">
                                        <%
                                            ArrayList<Order_Product> pendingship = (ArrayList<Order_Product>) request.getAttribute("pendingship");
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <%                                                if (pendingship != null) {
                                                        for (Order_Product i : pendingship) {
                                    ...
                                    <h6 class="card-title m-t-40"><i class="m-r-5 font-18 mdi mdi-numeric-1-box-multiple-outline"></i> Pending Pay Order</h6>
                                    <div class="table-responsive">
                                        <%
                                            ArrayList<Order_Product> pedingpayorder = (ArrayList<Order_Product>) request.getAttribute("pedingpayorder");
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <%                                                if (pedingpayorder != null) {
                                                        for (Order_Product i : pedingpayorder) {
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <%                                                if (successorder != null) {
                                                        for (Order_Product i : successorder) {
