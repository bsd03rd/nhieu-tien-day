                    ...
                    <div>
                        ...
                        <nav style="--bs-breadcrumb-divider: '>'" aria-label="breadcrumb">
                            <ol class="breadcrumb" style="font-size: 13px">
                                ...
                                <li class="breadcrumb-item"><a href="updatelesson?sectionid=${sectionid}&courseid=${courseid}">Update Lesson</a>
                                </li>
...
<!--                        <button class="btn btn-primary" type="button" data-bs-toggle="collapse"
            ...
            <form id="submitForm" action="updatelesson?lessonID=${lessonID}&quizID=${quizID}&button=Updatequestion&courseid=${courseid}&sectionid=${sectionid}" method="post">
